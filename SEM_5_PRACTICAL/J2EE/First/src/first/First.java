    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            do {
                ...
                switch (choice) {
                    case 1 -> p1_AddEmployee(con, sc);
                    case 2 -> p2_ViewAll(con);
                    case 3 -> p3_ViewHighSalary(con);
                    case 4 -> p4_ViewFromCity(con);
                    case 5 -> p5_ViewStartsWithA(con);
                    case 6 -> p6_ViewManagers(con);
                    case 7 -> p7_CountEmployees(con);
                    case 8 -> p8_HighestSalary(con);
                    case 9 -> p9_SortByName(con);
                    case 10 -> p10_SearchByEmpNo(con, sc);
                    case 11 -> p11_ListByDepartment(con, sc);
