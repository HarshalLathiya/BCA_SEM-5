...
@WebServlet(urlPatterns = {"/ColorForm"})
public class ColorForm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h2>Select Background Color</h2>");
            out.println("<form action='colorapply' method='get'>");
